...
from ISTKHAR_MUSIC.utils import help_pannel
from ISTKHAR_MUSIC.utils.database import get_lang
from ISTKHAR_MUSIC.utils.decorators.language import LanguageStart, languageCB
from ISTKHAR_MUSIC.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from ISTKHAR_MUSIC.utils.stuffs.buttons import BUTTONS
from ISTKHAR_MUSIC.utils.stuffs.helper import Helper
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_video(
            video="https://files.catbox.moe/4o3voo.mp4",
