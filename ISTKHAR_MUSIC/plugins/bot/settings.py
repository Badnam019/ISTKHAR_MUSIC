...
from ISTKHAR_MUSIC.utils.decorators.admins import ActualAdminCB
from ISTKHAR_MUSIC.utils.decorators.language import language, languageCB
from ISTKHAR_MUSIC.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from ISTKHAR_MUSIC.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://files.catbox.moe/4o3voo.mp4"),
