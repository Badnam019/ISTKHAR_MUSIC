...
from ISTKHAR_MUSIC.utils.database import add_sudo, remove_sudo
from ISTKHAR_MUSIC.utils.decorators.language import language
from ISTKHAR_MUSIC.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message, _):
    if message.from_user.id not in SUDOERS:
        return await message.reply_text("💔 <b>ᴏᴡɴᴇʀs:</b>\n1➤ <a href='https://t.me/TEAM_BADNAM_BOTS'>˹𝙎𝞪𝞰𝞪𝞽𝞪𝞰𝞲 </a>",
